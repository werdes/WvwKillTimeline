...
<head>
  ...
  <link rel="stylesheet"
    type="text/css"
    href="css/famfamfam-flags.min.css" />
...
<body>
  ...
  <script type="text/javascript"
    src="js/highstock.min.js"></script>
  <script type="text/javascript"
    src="js/highcharts.zeroalign.min.js"></script>
  <script type="text/javascript"
    src="js/highcharts.customEvents.min.js"></script>
  <script type="text/javascript"
